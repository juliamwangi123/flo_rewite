...
class SchedulePickupWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<SchedulePickupBloc, SchedulePickupState>(
          ...
          child: MultiFormSkeleton(
            ...
            children: [
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        '(It should be atleast 24hr notice )',
                        style: normalSize11Text(AppColors.deepNavy),
                      ),
                    ],
                  ),
                ],
                        ...
                        content: Container(
                          ...
                          child: SfDateRangePicker(
                            ...
                            onSelectionChanged: (
                              ...
                              final selectedDate =
                                  (args.value as DateTime).toString().split(
                                    ' ',
                                  )[0];
              ...
              FloAidCustomDropDownMenu(
                dropDownValue: state.currentForm.pickupTime.isEmpty ? 
                                dropDownValue: state.currentForm.pickupTime,
