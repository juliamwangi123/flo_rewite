...
class SchedulePickUpForm extends StatefulWidget {
  ...
  const SchedulePickUpForm({super.key, this.schedulePickupEntity});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Text(
            widget.schedulePickupEntity != null
                ? 'Edit Pickup'
                : 'Schedule Pick up',
...
>(
                      listener: (context, updateSate) {
                        if(updateSate.isLoading  == true ){
                         ...
                         if (updateSate.scheduledPickup != null &&
                                            ...
                                            if (currentStep == 0) {
                                              ...
                                              if (_formKey.currentState!
                                                ...
                                                if (widget
                                                    ...
                                                    null) {
                                                  context.read<UpdateScheduledPickupBloc>().add(
                                                    UpdateScheduledPickUpEvent(
                                                      updateScheduledPickupParams: UpdateScheduledPickupParams(
                                                        id:
                                                            widget
                                                                .schedulePickupEntity!
                                                                .id!,
                                                        pickupParams: SchedulePickupParams(
                                                          uId:
                                                              context
                                                                  .read<
                                                                    AuthBloc
